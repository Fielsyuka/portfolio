  ...
  skills: [
    {
      ...
      experiences: [
        ...
        },
        {
          ...
          date: '2019.06',
          time: '約20日間',
          description: 'Wordpress構築前の静的コーディング（11P）を担当しました。FLOCSSをベースにしたCSS設計をすることで、コーダー本人以外でも見やすい・管理しやすいコーディングファイルを作りました。メニュー類はWordpressデフォルトのテンプレートタグが使えるようにマークアップし、メニューが増減しても崩れないCSSを記述しました。スタイリッシュなデザインに合うCSSアニメーションを取り入れ、ワンランク上のコーポレートサイトに仕上がりました。',
